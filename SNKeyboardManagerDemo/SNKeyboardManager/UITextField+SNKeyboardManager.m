...
{
    objc_setAssociatedObject(self, @selector(isAutoAdjustFrameEnabled), @(sn_autoAdjustFrameEnabled), OBJC_ASSOCIATION_ASSIGN);
}
...
{
    objc_setAssociatedObject(self, @selector(sn_keyboardDistance), @(sn_keyboardDistance), OBJC_ASSOCIATION_ASSIGN);
}
...
{
    objc_setAssociatedObject(self, @selector(isRectAdjusted), @(rectAdjusted), OBJC_ASSOCIATION_ASSIGN);
}
...
{
    objc_setAssociatedObject(self, @selector(haveOtherResponder), @(haveOtherResponder), OBJC_ASSOCIATION_ASSIGN);
}
